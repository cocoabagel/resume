...
750万円もしくは現職と同等の700万円

## 希望業務

**リモートワークが認められているところ**
iOS、iPadOSなどのネイティブアプリ開発、UiKit->SwiftUI化、Swift 6対応やLiquid Glassなどの基盤改善や新規機能開発まで様々な施策の実現させていきたい。

## 5年後何をやりたいか

Swift言語とiOS基盤技術への深い理解を持ち、大規模アプリのアーキテクチャ設計をリードできるエンジニアになりたいと考えています。
Swift 6のConcurrencyやマクロなどの言語機能を熟知し、保守性・拡張性の高いモジュール設計を実現できる技術力を身につけたいです。
また、AIエージェントを活用した開発プロセスの効率化を推進し、チーム全体の生産性向上に貢献していきたいと考えています。
...
- ビルド・実行はXcodeで実施、[Proxyman](https://proxyman.com/)でAPI通信ログをチェック、[Reveal](https://revealapp.com/)でUIをチェック
...
- 植物（アガベチタノタ） / YouTube / ゲーム（ドラクエ、パルワールド、Cyberpunk 2077）
...
- 2週間ごとのスケジュール確認会で1ヶ月半先のバージョンから逆算してリリース機能を決定
- 1週間スプリントのスクラム開発で運用
